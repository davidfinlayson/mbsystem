 ...
 *  $Id: mbr_swplssxp.c 2183 2014-04-16 19:54:45Z caress $
 *
...
static char rcs_id[] = "$Id: mbr_swplssxp.c 2183 2014-04-16 19:54:45Z caress $";
...
int mbr_wt_swplssxp(int verbose, void *mbio_ptr, void *store_ptr, int *error)
{
	...
	/* write header record if needed (just once, here at top
	   of file) */
	...
	/* write projection record if needed (just once, here at top
	   of file) */
